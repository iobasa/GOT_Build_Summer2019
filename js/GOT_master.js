(() => {
    ...
    const houseData = [ // houseData[0][0] -> this is the house name ("stark")
        ["stark", `House Stark of Winterfell is a Great House of Westeros,
          ...
          // houseData[1][0] -> this is the house name ("baratheon")
        ["baratheon", `House Baratheon of Storm's End is a legally extinct Great
          ...
          // houseData[2][0] -> this is the house name ("lannister")
        ["lannister", `House Lannister of Casterly Rock is one of the Great Houses
          ...
          // houseData[3][0] -> this is the house name ("tully")
        ["tully", `House Tully of Riverrun is an exiled Great House of Westeros.
          ...
          // houseData[4][0] -> this is the house name ("greyjoy")
        ["greyjoy", `House Greyjoy of Pyke is one of the Great Houses of Westeros.
          ...
          // houseData[5][0] -> this is the house name ("arryn")
